...
Napisać aplikację, udostępniająca GUI, w którym po podanu miasta i nazwy kraju pokazywane są:
...
**UWAGA**
Aplikacja NIE kompiluje się kompiluje się bez klasy ApiKeys, która powinna zawierać dwie metody zwracające klucze API do wymaganych zewnętrznych serwisów.
